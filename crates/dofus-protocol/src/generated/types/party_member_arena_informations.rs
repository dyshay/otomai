...
/// Protocol type — ID: 1101
#[derive(Debug, Clone, Default)]
pub struct PartyMemberArenaInformations {
    pub id: i64,
    pub name: String,
    pub level: i16,
...
impl DofusSerialize for PartyMemberArenaInformations {
...
impl DofusDeserialize for PartyMemberArenaInformations {
...
impl DofusType for PartyMemberArenaInformations {
    const TYPE_ID: u16 = 1101;
}
