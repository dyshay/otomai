...
pub struct ObjectItemToSellInHumanVendorShop {
    ...
    pub public_price: i64,
}

impl DofusSerialize for ObjectItemToSellInHumanVendorShop {
    fn serialize(&self, writer: &mut BigEndianWriter) {
        ...
        writer.write_var_long(self.public_price);
    }
}

impl DofusDeserialize for ObjectItemToSellInHumanVendorShop {
    fn deserialize(reader: &mut BigEndianReader) -> Result<Self> {
        Ok(Self {
            ...
            public_price: reader.read_var_long()?,
        })
    }
}
