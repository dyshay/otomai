...
/// Protocol type — ID: 4082
#[derive(Debug, Clone, Default)]
pub struct ObjectItemToSellInBid {
    pub object_g_i_d: i16,
    pub effects: Vec<Vec<u8>>,
    pub object_u_i_d: i32,
    pub quantity: i32,
    pub object_price: i64,
    pub unsold_delay: i32,
}

impl DofusSerialize for ObjectItemToSellInBid {
    fn serialize(&self, writer: &mut BigEndianWriter) {
        ...
        writer.write_int(self.unsold_delay);
    }
}

impl DofusDeserialize for ObjectItemToSellInBid {
    fn deserialize(reader: &mut BigEndianReader) -> Result<Self> {
        Ok(Self {
            ...
            unsold_delay: reader.read_int()?,
        })
    }
}

impl DofusType for ObjectItemToSellInBid {
    const TYPE_ID: u16 = 4082;
}
