...
impl DofusSerialize for PartyMemberGeoPosition {
    fn serialize(&self, writer: &mut BigEndianWriter) {
        writer.write_int(self.member_id);
...
impl DofusDeserialize for PartyMemberGeoPosition {
    fn deserialize(reader: &mut BigEndianReader) -> Result<Self> {
        Ok(Self {
            member_id: reader.read_int()?,
